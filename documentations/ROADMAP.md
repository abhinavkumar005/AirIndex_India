...
- [ ] Phase 11 — Reproducible 30-day backtesting
- [ ] Phase 12 — DGCA reference adapter and validation report
- [ ] Phase 13 — Expanded automated test coverage and quality gates
- [ ] Phase 14 — Dockerized deployment and operational hardening
- [ ] Phase 15 — SIH demo dataset, presentation assets, and demo script

No phase should be marked complete until its deliverables exist and have been verified. Progression to the next major phase requires project-owner approval.
